...
<li>Verifique se não cortou nenhum fio do condutor — cabo torçido perde capacidade</li>
...
<div class="key-point"><span class="key-point__icon">🔄</span><div><strong>Emenda torçida</strong><p>Torça os fios e use conector de emenda (tipo porca de porcelana ou Wago). Nunca deixe emenda sem isolamento adequado.</p></div></div>
</div>
</div>
...
<div class="summary-section"><h2>📌 Pontos Importantes</h2><ul class="summary-list"><li>Sempre: confirmar ausência de tensão antes de conectar</li><li>Terra (verde): borne superior da tomada</li><li>Interruptor: interrompe a fase — nunca o neutro</li><li>Aperte os bornes e puxe os cabos para testar a fixação</li><li>Após instalar: re-energize e teste o funcionamento</li></ul></div>`
      ...
      quiz: {
        questions: [
          ...
          { text: 'Como preparar o cabo antes de conectar no borne de uma tomada?', options: [{ text: 'Usar os dentes para remover o isolamento', correct: false }, { text: 'Usar alicate decapador para remover apenas o necessário', correct: true }, { text: 'Cortar com estilete em diagonal com força', correct: false }, { text: 'Queimar levemente com isqueiro para amolecer o isolamento', correct: false }], explanation: 'O alicate decapador (ôu pelador de cabo) é a ferramenta correta. Remove o isolamento sem cortar os fios condutores, preservando a capacidade do cabo.' },
